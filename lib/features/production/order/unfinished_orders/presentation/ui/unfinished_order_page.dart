...
import '../widgets/unfinished_order_widget.dart';
import 'chart_page.dart';

class UnFinishedOrder extends StatefulWidget {
  const UnFinishedOrder({Key? key}) : super(key: key);

  static const String path = 'UnderwayOrder';
  static const String name = 'UnderwayOrder';
  ...
  @override
  State<UnFinishedOrder> createState() => _UnFinishedOrderState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(
        ...
        trailingIcons: [
          IconButton(
            icon: const Icon(Icons.insert_chart,size: 25),
            color: Colors.green,
            onPressed: () {
